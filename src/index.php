        ...
        <div class="d-flex justify-content-center mb-4">
            <div class="col-md-6">
                <div class="card h-100 shadow-sm">
                    <div class="card-body">
                        <h5 class="card-title text-danger">0. Instrukcja</h5>
                        <p class="card-text">Atak na bazę danych. Naucz się wyciągać ukryte rekordy i omijać logowanie.</p>
                        <a href="instrukcje.php" class="btn btn-outline-danger">Rozpocznij lekcję</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6">
             ...
             <div class="col-md-6">
                <div class="card h-100 shadow-sm border-secondary">
                    <div class="card-body">
                        <h5 class="card-title text-secondary">10. XML External Entity Injection</h5>
                        <p class="card-text">Przejęcie akcji użytkownika (np. zmiana hasła) przez złośliwe strony zewnętrzne.</p>
                        <a href="vuln_xxe.php" class="btn btn-outline-secondary">Lekcja 09</a>
                    </div>
                </div>
            </div>
             ...
             <div class="col-md-6">
                <div class="card h-100 shadow-sm border-secondary">
                    <div class="card-body">
                        ...
                        <p class="card-text">Przejęcie akcji użytkownika (np. zmiana hasła) przez złośliwe strony zewnętrzne.</p>
                        <a href="vuln_session-fixation.php" class="btn btn-outline-secondary">Lekcja 09</a>
                    </div>
                </div>
            </div>
             ...
             <div class="col-md-6">
                <div class="card h-100 shadow-sm border-secondary">
                    <div class="card-body">
                        ...
                        <p class="card-text">Przejęcie akcji użytkownika (np. zmiana hasła) przez złośliwe strony zewnętrzne.</p>
                        <a href="vuln_ssrf.php" class="btn btn-outline-secondary">Lekcja 09</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="card h-100 shadow-sm border-secondary">
                    <div class="card-body">
                        ...
                        <p class="card-text">Przejęcie akcji użytkownika (np. zmiana hasła) przez złośliwe strony zewnętrzne.</p>
                        <a href="vuln_rate-limiting.php" class="btn btn-outline-secondary">Lekcja 09</a>
                    </div>
                </div>
            </div>
             ...
             <div class="col-md-6">
                <div class="card h-100 shadow-sm border-secondary">
                    <div class="card-body">
                        <h5 class="card-title text-secondary">14. Rate Limiting</h5>
                        <p class="card-text">Przejęcie akcji użytkownika (np. zmiana hasła) przez złośliwe strony zewnętrzne.</p>
                        <a href="vuln_open-redirect.php" class="btn btn-outline-secondary">Lekcja 09</a>
                    </div>
                </div>
            </div>
              ...
              <div class="col-md-6">
                <div class="card h-100 shadow-sm border-secondary">
                    <div class="card-body">
                        ...
                        <p class="card-text">Przejęcie akcji użytkownika (np. zmiana hasła) przez złośliwe strony zewnętrzne.</p>
                        <a href="vuln_cors.php" class="btn btn-outline-secondary">Lekcja 09</a>
                    </div>
                </div>
            </div>
              ...
              <div class="col-md-6">
                <div class="card h-100 shadow-sm border-secondary">
                    <div class="card-body">
                        ...
                        <p class="card-text">Przejęcie akcji użytkownika (np. zmiana hasła) przez złośliwe strony zewnętrzne.</p>
                        <a href="vuln_clickjacking.php" class="btn btn-outline-secondary">Lekcja 09</a>
                    </div>
                </div>
            </div>
             ...
             <div class="col-md-6">
                <div class="card h-100 shadow-sm border-secondary">
                    <div class="card-body">
                        <h5 class="card-title text-secondary">17. Ataków na JWT</h5>
                        <p class="card-text">Przejęcie akcji użytkownika (np. zmiana hasła) przez złośliwe strony zewnętrzne.</p>
                        <a href="vuln_jwt-attacks.php" class="btn btn-outline-secondary">Lekcja 09</a>
                    </div>
                </div>
            </div>
